    ...
    return (
        <div className="main">
            <div className="maindetail">
                ...
                <h1 className=" mainMainHeading"><span> Maheen Sheikh</span> </h1>
                ...
                <a href="https://www.linkedin.com/in/ishkmaheen24/"><button className="leftButton">Hire me</button></a>
                <a href="https://github.com/ishk-maheen"><button className="rightButton">See Projects</button></a>
            </div>
            <div className="mypic">
